  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved parameter as @parameter" do
        ...
        post :create, {:parameter => { "playground_id" => "invalid value" }}, valid_session
        assigns(:parameter).should be_a_new(Parameter)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested parameter" do
        ...
        Parameter.any_instance.should_receive(:update).with({ "playground_id" => "1" })
        put :update, {:id => parameter.to_param, :parameter => { "playground_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the parameter as @parameter" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Parameter.any_instance.stub(:save).and_return(false)
        put :update, {:id => parameter.to_param, :parameter => { "playground_id" => "invalid value" }}, valid_session
        assigns(:parameter).should eq(parameter)
      end
