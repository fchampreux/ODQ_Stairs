...
describe "data_processes/new" do
  before(:each) do
    assign(:data_process, stub_model(DataProcess,
      :playground_id => 1,
      :name => "MyString",
      :description => "MyText",
      :created_by => "MyString",
  ...
  it "renders new data_process form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", data_processes_path, "post" do
