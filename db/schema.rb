...
ActiveRecord::Schema.define(version: 20141204143356) do
  ...
  create_table "dm_measures", id: false, force: true do |t|
    t.integer   "playground_id",                  precision: 38, scale: 0
    t.integer   "odq_object_id",                  precision: 38, scale: 0, null: false
    t.integer   "odq_parent_id",                  precision: 38, scale: 0
