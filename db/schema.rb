...
ActiveRecord::Schema.define(version: 20180317234616) do
  ...
  create_table "dm_activities", id: :serial, force: :cascade do |t|
    ...
    t.decimal "workload", precision: 12, scale: 2, default: "0.0"
    t.decimal "added_value", precision: 12, scale: 2, default: "0.0"
    t.decimal "maintenance_cost", precision: 12, scale: 2, default: "0.0"
    t.string "created_by", limit: 100, null: false
    t.string "updated_by", limit: 100, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
