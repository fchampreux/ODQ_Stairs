create or replace function odq_app.bitAND2 (parm1 integer, parm2 integer) RETURNS integer
AS $$
...
create or replace function odq_app.bitAND3 (parm1 IN integer, parm2 IN integer, parm3 IN integer) RETURNS integer
IS
output_value integer;
BEGIN
...
create or replace function odq_app.bitOR (parm1 IN integer, parm2 IN integer) RETURNS integer
IS
output_value integer;
BEGIN
