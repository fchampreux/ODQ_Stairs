...
select M.PLAYGROUND_ID,ODQ_OBJECT_ID,ODQ_PARENT_ID,ODQ_OBJECT_NAME, ODQ_OBJECT_CODE, ODQ_OBJECT_URL, T.PERIOD_DAY,ALL_RECORDS,ERROR_COUNT,SCORE,WORKLOAD,ADDED_VALUE,MAINTENANCE_COST, T.PERIOD_ID,M.CREATED_BY,M.UPDATED_BY,M.CREATED_AT,M.UPDATED_AT,0
from odq_dwh.dm_measures M inner join odq_dwh.dim_time T on T.period_id = M.period_id + 10 
